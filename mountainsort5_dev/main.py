...
app = App(
    ...
    app_image="ghcr.io/scratchrealm/pc-mountainsort5_dev:latest",
...
class Mountainsort5DevProcessor(ProcessorBase):
    ...
    def run(context: Mountainsort5ProcessorContext):
        ...
        print('Starting mountainsort5-dev processor')
        start_timer()
...
app.add_processor(Mountainsort5DevProcessor)
