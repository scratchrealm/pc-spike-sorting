...
# This one sets eps to 1e-16 instead of 1e-8
        ...
        **random_chunk_kwargs,
        ...
        if W is not None:
            ...
            W, M = compute_whitening_matrix(
                recording, mode, random_chunk_kwargs, apply_mean, radius_um=radius_um, eps=1e-16
            )
...
def compute_whitening_matrix(recording, mode, random_chunk_kwargs, apply_mean, radius_um=None, eps=1e-16):
    """
